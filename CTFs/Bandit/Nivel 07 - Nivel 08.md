...
**El Problema:** El archivo **data.txt** es gigante. Si uso `cat`, me inunda la pantalla con miles de líneas y es imposible leer algo. Necesito algo que busque por mí.
