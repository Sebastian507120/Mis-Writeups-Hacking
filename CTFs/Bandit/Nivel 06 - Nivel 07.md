...
Al ejecutar este comando el resultado será una ruta en la cual esta el archivo que encaja con todas las propiedades y se acopla a todos los filtro que pusimos en el `find` a esa ruta que nos arroja toca hacerle un cat en mi caso quedaria de la siguiente manera: 
