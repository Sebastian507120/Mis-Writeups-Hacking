...
### PASO 1: Recuperar la credencial actual 
Primero necesitaba tener a mano la contraseña del **nivel 14** (la que conseguí en el nivel anterior).
**Comando:** `cat /etc/bandit_pass/bandit14`.
Copio la contraseña que sale en la pantalla
