...
Intenté entrar normalmente y fui expulsado.
  **Problema:** Veía el banner de bienvenida y luego **Connection to bandit.labs.overthewire.org closed.**
...
Modifiqué mi comando **SSH** para obligar al servidor a usar un programa especifico **/bin/sh, que es una consola simple** en lugar de la consola tramposa.
...
Al ejecutar el comando anterior, no me apareció el nombre `bandit18@bandit:~$` bonito que siempre aparecía, sino un cursor simple. Pero lo importante: !No nos expulsó esta vez¡

Escribí `ls` y vi que había un archivo llamado **readme**.

### PASO 4: Leer la contraseña
Como ya tenía el control, solo tuve que leer ese archivo
Comando: `cat readme`.

**Resultado:** El servidor me mostró la contraseña para el **Nivel 19** que en mi caso es : `cGWpMaKXVwDUNgPAVJbWYuGHVn9zl3j8`

Ya con la contraseña solo nos queda loguearnos como lo hacíamos en niveles anteriores : `sshpass -p 'cGWpMaKXVwDUNgPAVJbWYuGHVn9zl3j8' ssh bandit19@bandit.labs.overthewire.org -p 2220`