...
Aprendi que para depurar o explorar conexiónes de red. es vitar ver ambos lados de la comunicación.
...
PASO 1: Prepara el entorno  (Divifir la pantalla)
Para replicar el método de S4vitar, necesito dos teminales conectadas al mismo tiempo a Bandit20.

  -Implementado: Abrir dos pestañas en mi consola (Kitty) y conectarme por SSH en ambas.

PASO 2: Configurar el "Oido" (Terminal 1)
