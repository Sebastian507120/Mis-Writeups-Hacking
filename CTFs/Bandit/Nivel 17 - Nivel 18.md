...
- **Símbolo** `< (Menor que):` Indica líneas que están en el archivo "viejo" (el primero que pongo en el comando).
- **Símbolo** `> (Mayor que):` Indica líneas que están en el archivo "nuevo" (el segundo que pongo en el comando).
...
Entendí que la línea con el símbolo `>` (la de abajo) correspondía al archivo nuevo **passwords.new**.
